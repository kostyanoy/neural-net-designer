...
- Валидация графа
  - Проверка связности графа (все блоки в одном графе)
  - Проверка совместимости слоев (в идеале нельзя воткнуть не тот)
  - Проверка наличия Input/Output (всегда один вход и выход)
